...
@interface StationVIPVC () <UITableViewDelegate,UITableViewDataSource>{
...
- (void)viewDidLoad {
    ...
    [self.viewNaviBar setTitle:Local(@"StationCard")];
    selectIndex = -1;
    [self initViews];
    [UIUtil showHUD:self.view];
    [_mainViewVM getStationProgramWithBlock:^(NSArray *array, BOOL ret) {
