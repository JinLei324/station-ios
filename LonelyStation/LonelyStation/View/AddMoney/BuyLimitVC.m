...
@interface BuyLimitVC ()<UITableViewDelegate,UITableViewDataSource>{
...
- (void)viewDidLoad {
    ...
    [self.viewNaviBar setTitle:Local(@"UnlimitChat")];
    selectIndex = -1;
    [self initViews];
    [UIUtil showHUD:self.view];
    [_mainViewVM getLimitProgramWithBlock:^(NSArray *array, BOOL ret) {
