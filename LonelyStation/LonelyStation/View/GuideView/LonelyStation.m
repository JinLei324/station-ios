...
@interface LonelyStation ()<UIScrollViewDelegate>
...
+(instancetype)newFeatureVCWithModels:(NSArray *)models enterBlock:(void(^)())enterBlock{
    ...
    LonelyStation *newFeatureVC = [[LonelyStation alloc] init];
...
-(void)viewDidLoad{
    ...
    UIImageView *backgroundImageView = [[UIImageView alloc] initWithFrame:Rect(0, 0, kScreenW, kScreenH)];
