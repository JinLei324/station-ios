...
//    _upperTouchEdgeInsets = UIEdgeInsetsMake(-5, -5, -5, -5);
    ...
    _lowerHandleHiddenWidth = 150.0f;
    _upperHandleHiddenWidth = 150.0f;
    
    _lowerTouchEdgeInsets = UIEdgeInsetsMake(-50, -50, -50, -50);
    _upperTouchEdgeInsets = UIEdgeInsetsMake(-50, -50, -50, -50);
